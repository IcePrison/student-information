...
//学生信息数组
function student(numberTxt, nameTxt, academyTxt, majorTxt, gradeTxt, classTxt,ageTxt) {
...
message.push(new student(11503080101, "齐桓公", "计算机科学与工程学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080102, "鲍叔牙", "数理学院", "软件工程", 2015, 3, 21));
message.push(new student(11503080103, "烛之武", "数理学院", "软件工程", 2015, 4, 21));
message.push(new student(11503080104, "孙膑", "经济与贸易学院", "软件工程", 2015, 2, 20));
message.push(new student(11503080105, "赵括", "经济与贸易学院", "软件工程", 2015, 2, 20));
message.push(new student(11503080106, "韩非", "重庆汽车学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080107, "孟子", "重庆汽车学院", "软件工程", 2015, 3, 22));
message.push(new student(11503080108, "荀子", "人文社会科学学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080109, "吕不韦", "人文社会科学学院", "软件工程", 2015, 2, 22));
message.push(new student(11503080110, "吴广", "工商管理学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080111, "樊哙", "工商管理学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080112, "嫪毐", "计算机科学与工程学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080113, "项庄", "计算机科学与工程学院", "软件工程", 2015, 4, 19));
message.push(new student(11503080114, "刘邦", "生物工程学院院", "软件工程", 2015, 2, 21));
message.push(new student(11503080115, "袁术", "生物工程学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080116, "吕禄", "计算机科学与工程学院", "软件工程", 2015, 2, 19));
message.push(new student(11503080117, "孙权", "商贸信息学院", "软件工程", 2015, 3, 21));
message.push(new student(11503080118, "曹操", "计算机科学与工程学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080119, "刘备", "商贸信息学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080120, "黄忠", "计算机科学与工程学院", "软件工程", 2015, 1, 21));
message.push(new student(11503080121, "马超", "计算机科学与工程学院", "软件工程", 2015, 2, 19));
message.push(new student(11503080122, "魏延", "重庆知识产权学院", "软件工程", 2015, 1, 21));
message.push(new student(11503080123, "法正", "计算机科学与工程学院", "软件工程", 2015, 2, 21));
message.push(new student(11503080124, "庞统", "重庆知识产权学院", "软件工程", 2015, 2, 21));
...
function addStudent(){
	...
	button.onclick = function submit(){
		...
		message.unshift(new student(number,name,academy,major,grade,classTxt1,age))
		sum++;
		changeCheckBox()
		changeLook()
		changeModify()
